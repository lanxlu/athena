 ...
 * $Id$
 * $Revision$
 * Last Changed by SJ at 2016年4月27日 下午2:47:50
 * $URL$
 *
 * Change Log
...
public class ScanPackage
{
    ...
    public ScanPackage(boolean excludeInner, boolean checkInOrEx, List<String> classFilters)
    {
    ...
    public static void main(String[] args) {
        ...
        classFilters.add("Client*");

        // 创建一个扫描处理器，排除内部类 扫描符合条件的类
        ScanPackage handler = new ScanPackage(true, true,
                classFilters);
...
//        classFilters.add("Hessian*");
        calssList = handler.getPackageAllClasses("cn.com.sand.frame.athena.annotation", true);
        for (Class<?> cla : calssList) {
            System.out.println(cla.getName());
        }
    }
